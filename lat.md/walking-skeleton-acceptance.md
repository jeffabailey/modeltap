...
The driver is in [[tests/acceptance/cache_walking_skeleton.rs]] (cucumber entry point) and the step implementations in [[tests/acceptance/steps/cache_lifecycle.rs]] (~19 KB of Given/When/Then bindings covering fixture construction, process invocation, JSONL parsing, and CACHE seam assertions).
