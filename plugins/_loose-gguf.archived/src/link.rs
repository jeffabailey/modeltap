//! `Tool::link` implementation for loose GGUFs.
//!
//! Loose GGUFs are plain `.gguf` files in user-convention directories. No
//! manifest, no content-addressing — the user invokes `llama-cli -m <path>`
//! (or any other GGUF runner) directly against the file.
//!
